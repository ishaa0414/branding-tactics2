...
// Helper function to get ID from slug
const getIdFromSlug = (slug, clients) => {
  const client = clients.find(client => generateSlug(client.name) === slug);
...
const clientsData = [
  {
    ...
    caseStudyCover:"/case-study-cover/fizmaa.jpg",
  ...
  },
  {
    ...
    caseStudyCover:"/case-study-cover/acrements.jpg",
  ...
  },
  {
    ...
    caseStudyCover:"/case-study-cover/riple.png",
  ...
  },
  {
    ...
    caseStudyCover:"/case-study-cover/Digimark.jpg",
  ...
  },
  {
    ...
    caseStudyCover:"/case-study-cover/sam.jpg",
  ...
  },
  {
    ...
    caseStudyCover:"/case-study-cover/fizmaa.jpg",
    projectImage:"/project-images/Khet.jpg",
  ...
  },
  {
    ...
    caseStudyCover:"/case-study-cover/Genki.jpg",
...
export const CaseStudyProvider = ({ children }) => {
  ...
  // Function to get a single case study by slug - FIXED: Now properly async
  const getCaseStudyBySlug = async (slug) => {
    setLoading(true);
    // Simulate API call delay for consistency
    await new Promise(resolve => setTimeout(resolve, 100));
    
    const id = getIdFromSlug(slug, clients);
    const study = id ? clients.find(client => client.id === id) : null;
